#include "../../include/armor_detector/ROI_Accelerator.h"

// 初始全图
    ROIAccelerator::ROIAccelerator()
    {
        roi = cv::Rect(0, 0, 1280, 1024);
//        roi = cv::Rect(0, 0, 720, 480);
        roi_shut_down = true;
    }
...
//        point.x = point.x > 720 ? 480 : (point.x < 0 ? 0 : point.x);
//        point.y = point.y > 720 ? 480 : (point.y < 0 ? 0 : point.y);
    }
