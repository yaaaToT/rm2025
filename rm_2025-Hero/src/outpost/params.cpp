...
using namespace std;
    ...
    double CameraParam::yaw;
    double CameraParam::pitch;
    double CameraParam::roll;
    ...
    GroundChassisData SerialParam::recv_data;
    HostComputerData SerialParam::send_data;
    vector<GroundChassisData> SerialParam::serial_data_sets(1000);
